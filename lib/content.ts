...
export const fallbackPortfolio = [
  {
    ...
    type: "OFFICE",
    title: "AI 업무 자동화 템플릿",
    description: "회의록 요약, 이메일 초안, 보고서 구조화를 하나의 반복 흐름으로 정리한 결과물입니다.",
    thumbnailUrl: null,
    videoUrl: null,
    order: 1,
    published: true,
  ...
  },
  {
    ...
    description: "콘셉트, 카피, 이미지, 숏폼 영상까지 연결한 홍보 콘텐츠 포트폴리오입니다.",
    thumbnailUrl: null,
    videoUrl: null,
    order: 2,
    published: true,
  ...
  },
  {
    ...
    type: "AGENT",
    title: "업무 에이전트 설계서",
    description: "목표, 입력값, 실행 단계, 검증 기준을 갖춘 직접 구축형 에이전트 설계 결과물입니다.",
    thumbnailUrl: null,
    videoUrl: null,
    order: 3,
    published: true,
